...
files="zprofile zshrc zshenv zsh_aliases vimrc tmux.conf gitconfig gitignore_global editorconfig todo.cfg bin"    # list of files/folders to symlink in homedir
