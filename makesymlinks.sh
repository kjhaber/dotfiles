...
files="zprofile zshrc zshenv zsh_aliases vimrc tmux.conf gitconfig gitignore_global editorconfig todo.cfg bin aws"    # list of files/folders to symlink in homedir
